...
export default {
  data() {
    return {
      ...
      languages: [{
        flag: import("@/assets/images/flags/us.svg"),
        language: "en",
        title: "English",
      }
      ],
  ...
  computed: {
    ...
    // },
    // getUserData() {
    //   console.log("qqqq",this.$store.user);
   ...
   mounted() {
    ...
    if (appConfig.APP_LOCALE) {
      this.flag = appConfig.APP_LOCALE;
      ...
      <div class="navbar-header">
        ...
        <div class="d-flex align-items-center">
          ...
          <BDropdown variant="link" class="ms-sm-3 header-item topbar-user" toggle-class="rounded-circle arrow-none"
            ...
            <router-link class="dropdown-item" :to="{ name: 'account.profile' }"><i
            ...
            <router-link   class="dropdown-item" :to="{'name':'logout'}"><i class="mdi mdi-logout text-muted fs-16 align-middle me-1"></i>
