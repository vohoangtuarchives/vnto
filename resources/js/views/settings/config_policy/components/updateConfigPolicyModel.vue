        ...
        <div v-if="isTermContract == false" >
          <div class="mb-3">
            ...
            <b-form-textarea
                    ...
                    id="textarea"
                    v-model="ser_include" 
                    :placeholder="$t('dichvu.dichvubaogom')"
                    rows="3"
                    max-rows="6"
                  ></b-form-textarea>
          </div>
          <div class="mb-3">
            ...
            <b-form-textarea
                    class="form-control"
                    id="textarea"
                    v-model="ser_no_nclude" 
                    :placeholder="$t('dichvu.dichvukhongbaogom')"
                    rows="3"
                    max-rows="6"
                  ></b-form-textarea>
          </div>
          <div class="mb-3">
            ...
            <b-form-textarea
                    ...
                    :placeholder="$t('dichvu.chinhsachhoanhuy')"
                    rows="3"
                    max-rows="6"
                  ></b-form-textarea>
          </div>
          <div class="mb-3">
            ...
            <b-form-textarea
                    class="form-control"
                    id="textarea"
                    v-model="surcharge_policy" 
                    :placeholder="$t('dichvu.chinhsachphuthu')"
                    rows="3"
                    max-rows="6"
                  ></b-form-textarea>
          </div>
          <div class="mb-3">
            ...
            <b-form-textarea
                    ...
                    :placeholder="$t('dichvu.chinhsachtreem')"
                    rows="3"
                    max-rows="6"
                  ></b-form-textarea>
          </div>
          <div class="mb-3">
            ...
            <b-form-textarea
                    class="form-control"
                    id="textarea"
                    v-model="special_policy" 
                    :placeholder="$t('dichvu.luuydacbiet')"
                    rows="3"
                    max-rows="6"
                  ></b-form-textarea>
          </div>
        </div>
        <div class="mb-3" v-if="isTermContract == true">
          <label class="form-label">{{ $t('dichvu.dieukhoanhopdong') }} (<span class="text-danger">*</span>)</label>
          <b-form-textarea
                  class="form-control"
                  id="textarea"
                  v-model="terms_of_contract" 
                  :placeholder="$t('dichvu.dieukhoanhopdong')"
                  rows="3"
                  max-rows="6"
                ></b-form-textarea>
        </div>
