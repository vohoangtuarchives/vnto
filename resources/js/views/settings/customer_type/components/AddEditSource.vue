    ...
    export default {
        ...
        methods: {
            ...
            async  updateOrCreateSource() {
                ...
                SettingService.updateOrCreateSource ({'name':this.name,'target':this.target,'status':status,id:this.id}).then((rs)=>{
...
<template>
    <div>
        ...
        <div class="modal-body">
            ...
            <div class="mb-3">
                <label class="form-label">{{ $t('tennguon') }} (<span class="text-danger">*</span>)</label>
                <input type="text" v-model="name" class="form-control" :placeholder=" $t('tennguon') " >
            </div>
            <div class="mb-3">
