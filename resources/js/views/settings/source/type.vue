<script>
    ...
    export default {
        ...
        methods:{
            getData(page){
                SettingService.getListCustomerSource(page,'type').then((response)=>{
            ...
            addSourceModal(data) {
                ...
                this
                    ...
                    .open({
                        ...
                        contentProps: {
                            title: data==null?this.$t('themmoiloaikhachhang'):this.$t('capnhatloaikhachhang'),
                            item:data,
                            type:'type'
                        },
...
<template>
    <Layout>
        <PageHeader title="loaikhachhang" pageTitle="Dashboard"/>
        <BRow>
            <BCol cols="12">
                        <BCard>
