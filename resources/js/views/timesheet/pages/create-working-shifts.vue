<template>
  <Layout>
    <PageHeader title="Tạo ca làm vệc " pageTitle="Dashboard" />
    <BForm>
      <BCard>
          ...
          <BRow class="mb-3">
            <BCol cols="12" xl="12" md="12">
              <BRow class="align-items-center">
                <BCol  xl="2" md="3">
                  <label :for="name" class="m-0">{{ $t('timesheet.working-shift.form.name') }} (<span class="text-danger">*</span>)</label>
                </BCol>
                <BCol xl="8" md="9">
        ...
        <BRow class="mb-3">
          <BCol cols="12" xl="12">
            <BRow class="align-items-center">
              <BCol  xl="2" md="3">
                <label :for="code" class="m-0">{{ $t('timesheet.working-shift.form.code') }} (<span class="text-danger">*</span>)</label>
              </BCol>
              <BCol xl="8" md="9">
        ...
        <BRow class="mb-3">
          <BCol cols="12" xl="12">
            <BRow class="align-items-center mb-3">
              <BCol  xl="2" md="3">
                <label :for="start_time" class="m-0">{{ $t('timesheet.working-shift.form.start_time') }} (<span class="text-danger">*</span>)</label>
              </BCol>
              <BCol xl="2" md="5">
              ...
              <BCol  xl="2">
                <div class="d-flex align-items-center">
                  ...
                  <label class="form-label  mb-0">{{ $t("timesheet.working-shift.form.check_start_time") }}</label>
                </div>
              </BCol>
            <template v-if="item.check_start_time">
              <BCol  xl="2" lg="3">
                <BRow class="align-items-center mb-3 ">
                  <BCol  xl="2">
                    <label :for="check_start_time_from" class="m-0">{{ $t('timesheet.working-shift.form.check_start_time_from') }}</label>
                  </BCol>
                  <BCol xl="10">
              ...
              <BCol  xl="2" lg="3">
                <BRow class="align-items-center mb-3 ">
                  <BCol  xl="2">
                    <label :for="check_start_time_to" class="m-0">{{ $t('timesheet.working-shift.form.check_start_time_to') }}</label>
                  </BCol>
                  <BCol xl="10">
        ...
        <BRow class="mb-3">
          <BCol cols="12" xl="12">
            <BRow class="mb-3 align-items-center ">
              <BCol   xl="2">
                <label :for="end_time" class="m-0">{{ $t('timesheet.working-shift.form.end_time') }} (<span class="text-danger">*</span>)</label>
              </BCol>
              <BCol xl="2">
              ...
              <BCol  xl="2">
                <div class="d-flex align-items-center">
                  ...
                  <label class="form-label  mb-0">{{ $t("timesheet.working-shift.form.check_end_time") }}</label>
                </div>
              </BCol>
            <template v-if="item.check_end_time">
              <BCol  xl="2" lg="3">
                <BRow class="align-items-center mb-3">
                  <BCol  xl="2">
                    <label :for="check_end_time_from" class="m-0">{{ $t('timesheet.working-shift.form.check_end_time_from') }}</label>
                  </BCol>
                  <BCol xl="10">
              ...
              <BCol  xl="2" lg="3">
                <BRow class="align-items-center mb-3">
                  <BCol  xl="2">
                    <label :for="check_end_time_to" class="m-0">{{ $t('timesheet.working-shift.form.check_end_time_to') }}</label>
                  </BCol>
                  <BCol xl="10">
       ...
       <BRow class="mb-3">
         <Bcol>
           <div class="d-flex align-items-center">
             ...
             <label class="form-label  mb-0">{{ $t("timesheet.working-shift.form.is_break_time") }}</label>
           </div>
         </Bcol>
       </BRow>
      <template v-if="item.is_break_time">
        ...
        <BRow class="mb-3">
          <BCol cols="12" xl="12">
            <BRow class="align-items-center">
              <BCol   xl="2">
                <label :for="start_break_time" class="m-0">{{ $t('timesheet.working-shift.form.start_break_time') }} (<span class="text-danger">*</span>)</label>
              </BCol>
              <BCol xl="2">
              ...
              <BCol  xl="2">
                <div class="d-flex align-items-center mb-3">
                  ...
                  <label class="form-label  mb-0">{{ $t("timesheet.working-shift.form.check_break_time_out") }}</label>
                </div>
              </BCol>
              <template v-if="item.check_break_time_out  ||  item.check_break_time_in">
                <BCol xl="3">
                  <BRow class="align-items-center mb-3">
                    <BCol  xl="3">
                      <label :for="break_time_out_from" class="m-0">{{ $t('timesheet.working-shift.form.break_time_out_from') }} (<span class="text-danger">*</span>)</label>
                    </BCol>
                    <BCol xl="9">
        ...
        <BRow class="mb-3">
          <BCol cols="12" xl="12">
            <BRow class="align-items-center mb-3">
              <BCol   xl="2">
                <label :for="end_break_time" class="m-0">{{ $t('timesheet.working-shift.form.end_break_time') }}  (<span class="text-danger">*</span>)</label>
              </BCol>
              <BCol xl="2">
              ...
              <BCol  xl="2">
                <div class="d-flex align-items-center">
                  ...
                  <label class="form-label  mb-0">{{ $t("timesheet.working-shift.form.check_break_time_in") }} </label>
                </div>
              </BCol>
              <template v-if="item.check_break_time_out  ||  item.check_break_time_in">
                <BCol xl="3">
                  <BRow class="align-items-center">
                    <BCol  xl="3">
                      <label :for="break_time_in_to" class="m-0">{{ $t('timesheet.working-shift.form.break_time_in_to') }} (<span class="text-danger">*</span>)</label>
                    </BCol>
                    <BCol xl="9">
        ...
        <BRow class="my-4">
            <BCol>
              <strong class="text-uppercase  text-danger-emphasis">{{ $t("timesheet.working-shift.calculation") }}</strong>
            </BCol>
        </BRow>
          ...
          <BCol xl="12">
            <BRow class="mb-3 justify-content-event">
              <BCol cols="12" xl="12">
                <BRow class="align-items-center mb-3">
                  <BCol  xl="2">
                    <label :for="working_hour" class="m-0">{{ $t('timesheet.working-shift.form.working_hour') }}</label>
                  </BCol>
                  <BCol xl="5">
              ...
              <BCol cols="12" xl="12">
                <BRow class="align-items-center mb-3">
                  <BCol  xl="2">
                    <label :for="working_day" class="m-0">{{ $t('timesheet.working-shift.form.working_day') }}</label>
                  </BCol>
                  <BCol xl="5">
        ...
        <BRow class="my-4">
          <BCol>
            <strong class="text-uppercase text-danger-emphasis">{{ $t("timesheet.working-shift.calculation-rate") }}</strong>
          </BCol>
        </BRow>
          ...
          <BCol xl="12">
            <BRow class="mb-3 justify-content-event">
              <BCol cols="12" xl="12">
                <BRow class="align-items-center mb-3">
                  <BCol  xl="2">
                    <label :for="working_rate_weekday" class="m-0">{{ $t('timesheet.working-shift.form.working_rate_weekday') }}</label>
                  </BCol>
                  <BCol xl="5">
              ...
              <BCol cols="12" xl="12">
                <BRow class="align-items-center mb-3">
                  <BCol  xl="2">
                    <label :for="working_rate_weekend" class="m-0">{{ $t('timesheet.working-shift.form.working_rate_weekend') }}</label>
                  </BCol>
                  <BCol xl="5">
              ...
              <BCol cols="12" xl="12">
                <BRow class="align-items-center">
                  <BCol  xl="2">
                    <label :for="working_rate_holiday" class="m-0">{{ $t('timesheet.working-shift.form.working_rate_holiday') }}</label>
                  </BCol>
                  <BCol xl="5">
        ...
        <BRow class="mb-3">
          <Bcol>
            <div class="d-flex align-items-center">
              ...
              <label class="form-label  mb-0">{{ $t("timesheet.working-shift.form.is_show_without_check_in") }}</label>
            </div>
          </Bcol>
        </BRow>
            ...
            <BCol xl="12">
              <BRow class="mb-3 justify-content-event">
                <BCol cols="12" xl="12">
                  <BRow class="align-items-center mb-3">
                    <BCol  xl="2">
                      <label :for="working_hour_without_check_in" class="m-0">{{ $t('timesheet.working-shift.form.working_hour_without_check_in') }}</label>
                    </BCol>
                    <BCol xl="5">
                ...
                <BCol cols="12" xl="12">
                  <BRow class="align-items-center">
                    <BCol  xl="2">
                      <label :for="working_day_without_check_in" class="m-0">{{ $t('timesheet.working-shift.form.working_day_without_check_in') }}</label>
                    </BCol>
                    <BCol xl="5">
        ...
        <BRow class="mb-3">
          <Bcol>
            <div class="d-flex align-items-center">
              ...
              <label class="form-label  mb-0">{{ $t("timesheet.working-shift.form.is_show_without_check_out") }}</label>
            </div>
          </Bcol>
        </BRow>
            ...
            <BCol xl="12">
              <BRow class="mb-3 justify-content-event">
                <BCol cols="12" xl="12">
                  <BRow class="align-items-center mb-3">
                    <BCol  xl="2">
                      <label :for="working_hour_without_check_out" class="m-0">{{ $t('timesheet.working-shift.form.working_hour_without_check_out') }}</label>
                    </BCol>
                    <BCol xl="5">
                ...
                <BCol cols="12" xl="12">
                  <BRow class="align-items-center">
                    <BCol  xl="2">
                      <label :for="working_day_without_check_out" class="m-0">{{ $t('timesheet.working-shift.form.working_day_without_check_out') }}</label>
                    </BCol>
                    <BCol xl="5">
        ...
        <BRow class="mb-3">
          <Bcol>
            <div class="d-flex align-items-center">
              ...
              <label class="form-label  mb-0">{{ $t("timesheet.working-shift.form.is_allow_late_in_early_out") }}</label>
            </div>
          </Bcol>
        </BRow>
            ...
            <BCol xl="12" md="12">
              <BRow class="mb-3 justify-content-event">
                <BCol cols="12" xl="12" md="12">
                  <BRow class="align-items-center mb-3">
                    <BCol  xl="2" md="3">
                      <label :for="late_in_time" class="m-0">{{ $t('timesheet.working-shift.form.late_in_time') }}</label>
                    </BCol>
                    <BCol xl="5" md="7">
                ...
                <BCol cols="12" xl="12" md="12" >
                  <BRow class="align-items-center">
                    <BCol  xl="2" md="3">
                      <label :for="early_out_time" class="m-0">{{ $t('timesheet.working-shift.form.early_out_time') }}</label>
                    </BCol>
                    <BCol xl="5" md="7">
        ...
        <BCardFooter>
          <div class="d-flex justify-content-end">
            <BButton :loading="isLoading" type="submit" class="btn btn-success" @click="onCreateWorkingShift">{{ $t("capnhat") }}</BButton>
          </div>
...
export default {
  ...
  data(){
    return {
      item: WorkingShiftEntity.item
    }
  },
  methods: {
    async  onCreateWorkingShift(){
      let _this = this;
  ...
  validations () {
    return WorkingShiftEntity.validations(this.$t);
  },
}
</script>