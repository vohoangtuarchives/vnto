<script>
    ...
    export default {
        ...
        data() {
            return {defaultOptions: {}, modalShow: false, titleFormGroup: this.$t('t-themmoidanhmuc')};
        },
        ...
        methods: {
            errorImage(e){
                e.target.src = 'https://ngocthachsa.com/upload/hinhanh/blogo-(1)-4056.png'
            },
            
            

            // openSupplierAmenitiesItemModal() {     this         .$vbsModal
            // .open({              pass your component as the whole modal content you can
            // also use the              component's registered name             content:
            // SupplierAmenitiesFormModalComponent,             size: ModalSize.LARGE,
            // pass custom data as props to the EditProfileComponent.
            // contentProps: {                 idGroup: this.activeGroup             },
            // pass event listeners to the EditProfileComponent.             contentEmits: {
            // onSubmit: this.onSubmitProfileForm             },
            // backgroundScrolling: true,  default is false             staticBackdrop:
            // true,  will disable backdrop click to close modal if true         }); },
    ...
    <Layout>
                ...
                <div class="profile-foreground position-relative mx-n4 mt-n4">
                    <div class="profile-wid-bg">
                        <img :src="this.path+this.info.cover" alt="" class="profile-wid-img"/>
                    </div>
                </div>
                <div class="pt-4 mb-4 mb-lg-3 pb-lg-4 profile-wrapper">
                    <div class="row g-4">
                        <div class="col-auto">
                            <div class="avatar-lg">
                                <img
                                    :src="this.path+this.info.avatar"
                                    :onerror="errorImage"
                                    alt="user-img"
                        ...
                        <div class="col">
                            <div class="p-2">
                                <h3 class="text-white mb-1">{{this.info.name}}</h3>
                                <p class="text-white text-opacity-75">{{ this.info.position }}</p>
                                ...
                                <ul
                                    ...
                                    <li class="nav-item">
                                        <a
                                            ...
                                            <span class="d-none d-md-inline-block">{{$t('thongtinchung')}}</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link fs-14" data-bs-toggle="tab" href="#activities" role="tab">
                                            <i class="ri-list-unordered d-inline-block d-md-none"></i>
                                            <span class="d-none d-md-inline-block">{{$t('hoatdong')}}</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link fs-14" data-bs-toggle="tab" href="#projects" role="tab">
                                            <i class="ri-price-tag-line d-inline-block d-md-none"></i>
                                            <span class="d-none d-md-inline-block">{{$t('projects')}}</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link fs-14" data-bs-toggle="tab" href="#documents" role="tab">
                                            <i class="ri-folder-4-line d-inline-block d-md-none"></i>
                                            <span class="d-none d-md-inline-block">{{$t('document')}}</span>
                                        </a>
                                    </li>
                                </ul>
                                <div class="flex-shrink-0">
                                    <router-link :to="{name:'account.editprofile'}"  class="btn btn-success">
                                        <i class="ri-edit-box-line align-bottom"></i>
                                        {{$t('thaydoithongtin')}}</router-link>
                                </div>
                            </div>
                            <!-- Tab panes -->
                                ...
                                <div class="tab-pane active" id="overview-tab" role="tabpanel">
                                    <div class="row">
                                        <div class="col-xxl-3">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <h5 class="card-title mb-3">{{ $t('thongtinchung') }}</h5>
                                                    <div class="table-responsive">
                                                        <table class="table table-borderless mb-0">
                                                            <tbody>
                                                                <tr>
                                                                    <th class="ps-0" scope="row">{{$t('hoten')}} :</th>
                                                                    <td class="text-muted">{{ this.info.name }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th class="ps-0" scope="row">{{$t('dienthoai')}} :</th>
                                                                    <td class="text-muted">{{ this.info.phone }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th class="ps-0" scope="row">E-mail :</th>
                                                                    <td class="text-muted">{{ this.info.email }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th class="ps-0" scope="row">{{$t('diachi')}} :</th>
                                                                    <td class="text-muted">{{ this.info.location }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <th class="ps-0" scope="row">{{ $t('ngaythamgia') }}</th>
                                                                    <td class="text-muted"> {{ moment(this.info.created_at).format("ddd MMM DD, YYYY [at] HH:mm a") }}</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
                                        ...
                                        <div class="col-xxl-9">
                                            <div class="card">
                                                <div class="card-body">
                                                    <h5 class="card-title mb-3">{{$t('gioithieuchung')}}</h5>
                                                    {{ this.info.introduce }}
                                                                            ...
                                                                            <div class="accordion-item border-0">
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div class="accordion-body ms-2 ps-5 fst-italic">
                                                                                        ...
                                                                                        mornings of spring which I enjoy with my whole heart. Each design is a new,
                                                                                        unique piece of art birthed into this world, and while you have the opportunity
                                                                                    ...
                                                                                    <div class="accordion-item border-0">
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <div class="accordion-body ms-2 ps-5">
                                                                                                ...
                                                                                                right, and each letter has the perfect spot of its own.
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="accordion-item border-0">
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <div class="accordion-body ms-2 ps-5">
                                                                                                <p class="text-muted fst-italic mb-2">
                                                                                                    " This is an awesome admin dashboard template. It is extremely well structured
                                                                                                    and uses state of the art components (e.g. one of the only templates using
                                                                                                    boostrap 5.1.3 so far). I integrated it into a Rails 6 project. Needs manual
                                                ...
                                                <div class="tab-pane fade" id="projects" role="tabpanel">
                                                    ...
                                                    <div class="tab-pane fade" id="documents" role="tabpanel">
                                                        <div class="card">
                                                            <div class="card-body">
                                                                <div class="d-flex align-items-center mb-4">
                                                                    <h5 class="card-title flex-grow-1 mb-0">{{ $t('tailieu') }}</h5>
                                                                    <div class="flex-shrink-0">
